...
data class BF200Data(
    @Json(name = "B") val b: B,
    var serviceRelatedData:MutableList<Byte>?,
    var serviceDataIndex:Int?=null
)
...
data class B(
    ...
    @Json(name = "9F5B") val `9F5B`: String?,
    @Json(name = "9F15") val `9F15`: String?,
    @Json(name = "9F16") val `9F16`: String?,
    ...
    @Json(name = "9F1C") val `9F1C`: String?,
    @Json(name = "DF33") var `DF33`: String?,
)
